    ...
    var L = function(h) {
        var j = function(e) {
                    ...
                    for (i = b.length - 1; 0 <= i; i--) {
                        ...
                        for (g = j.length; f < g; f++)
                            if ("number" === typeof j[f] && 0 <= j[f]) {
                                ...
                                e = 0;
                                for (w = a.aoColumns.length; e < w; e++)("_all" == j[f] || h(a.aoColumns[e].nTh).hasClass(j[f])
                                    ) && d(e, b[i])
                            }
                    }
                if (c) {
            ...
            this.$ = function(a, b) {
                ...
                if ("current" == b.page) {
                    c = d._iDisplayStart;
                    for (d = d.fnDisplayEnd(); c < d; c++)(f = g[o[c]].nTr) 
                        && e.push(f)
                } else if ("current" == b.order && "none" == b.filter) {
                    c = 0;
                    for (d = k.length; c < d; c++)(f = g[k[c]].nTr) 
                        && e.push(f)
                } else if ("current" == b.order && "applied" == b.filter) {
                    c = 0;
                    for (d = o.length; c < d; c++)(f = g[o[c]].nTr) 
                        && e.push(f)
                } else if ("original" ==
                b.order && "none" == b.filter) {
                    c = 0;
                    for (d = g.length; c < d; c++)(f = g[c].nTr) 
                        && e.push(f)
            ...
            this.oApi = {
                ...
                _fnCreateCookie: function(a, b, c, d, e) {
                    ...
                    var c = X.location.pathname.split("http://sharpandnimble.com/"), a = a + "_" + c.pop().replace(/[\/:]/g, "").toLowerCase(), g;
                    null !== e ? (g = "function" === typeof h.parseJSON ? h.parseJSON(b) : eval("(" + b + ")"),
                    b = e(a, g, f.toGMTString(), c.join("http://sharpandnimble.com/") + "/")) : b = a + "=" + encodeURIComponent(b) + "; expires=" + f.toGMTString() + "; path=" + c.join("http://sharpandnimble.com/") + "/";
                    a = l.cookie.split(";");
                    e = b.split(";")[0].length;
                    f = [];
                    if (4096 < e + l.cookie.length + 10) {
                        ...
                        for (f.sort(function(a, b) {
                            ...
                            d = f.pop();
                            l.cookie =
                            d.name + "=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path=" + c.join("http://sharpandnimble.com/") + "/"
                        }
                    }
                    l.cookie = b
                },
                _fnReadCookie: function(a) {
                    for (var b = X.location.pathname.split("http://sharpandnimble.com/"), a = a + "_" + b[b.length - 1].replace(/[\/:]/g, "").toLowerCase() + "=", b = l.cookie.split(";"), c = 0; c < b.length; c++) {
