...
(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      ...
      directionNav: {
        setup: function() {
          var directionNavScaffold = $('<ul class="' + namespace + 'direction-nav"><li><a class="' + namespace + 'prev" href="#" style="display:block;">' + slider.vars.prevText + '<img src="images/prev.png" /></a></li><li><a class="' + namespace + 'next" href="#">' + slider.vars.nextText + '<img src="images/next.png" /></a></li></ul>');
