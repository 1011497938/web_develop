...
<div class="row">
          <div class="col-lg-12">
              <form enctype="multipart/form-data" action="<?php echo site_url("admin/parttime/modify/submit") ?>" method="post" id="titleimg">
              ...
              <div class="heading" style="height:330px">
               ...
               <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                    <label>酬劳（格式：￥100/月）  或  标签（例：合作）</label>
                    <input name="price" class="form-control" id="name" type="text" required="required" value="<?php echo $item->price ?>">
                </div>
                <i class="icon-edit"></i>文章编辑器
                  ...
                  <script type="text/javascript" charset="utf-8" src="../ueditor/lang/zh-cn/zh-cn.js"></script>
                          ...
                          <script id="editor" name="editor" type="text/plain" style="width:100%;height:200px;padding:15px 25px">
