            ...
            <div class="widget-container fluid-height">
                <div class="heading" style="height:500px">
                    ...
                    <div class="form-group col-md-12">
                        <label>标题（20字以内）</label><input name="title" class="form-control" id="name" type="text">
                    </div>
                    <div class="form-group col-md-12">
                      <label>类型</label>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select name="app_vc_kind" class="select2able">
                            <option value="1" selected = "selected">正经文章类</option>
                            <option value="0">微信推文类</option>
                        </select>
                    </div>
                    <div class="form-group col-md-12">
                        <label>副标题(20字以内，必填)</label><input name="summary" class="form-control" id="name" type="text"  required="required"/>
                    </div>
                    <div class="form-group col-md-12">
                        <label>发布者(必填)</label><input name="type" class="form-control" id="type" type="text">
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        ...
                        <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 100%; max-height: 150px">
                        </div>
                ...
                <div class="col-md-10">
                <script id="editor" name="editor" type="text/plain" style="width:100%;height:200px;padding:15px 5px"></script>
                </div>
            </div>
